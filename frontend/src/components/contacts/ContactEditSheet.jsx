...
export default function ContactEditSheet({ open, contact, onClose, onSave }) {
  ...
  const [homeRegions, setHomeRegions] = useState(["대전"]);
  ...
  useEffect(() => {
    ...
    setHomeRegions(normalizeActivityRegions(contact.homeRegions ?? contact.homeRegion));
  ...
  const regionLabel = useMemo(() => formatRegionsLabel(homeRegions), [homeRegions]);
  ...
  const handleSave = () => {
    ...
    const regions = normalizeActivityRegions(homeRegions);
    onSave?.({
      name: trimmedName,
      nickname: trimmedName,
      phone: phone.trim(),
      homeRegions: regions,
      homeRegion: formatRegionsLabel(regions, { emptyLabel: "" }),
      trade,
      ...
      <div className="contact-edit-sheet" role="dialog" aria-modal="true" aria-label={`${displayName} 정보 수정`}>
        ...
        <div className="contact-edit-sheet__panel">
          ...
          <div className="contact-edit-sheet__body">
            ...
            <div className="contact-edit-sheet__field">
              <span className="contact-edit-sheet__label">공종</span>
